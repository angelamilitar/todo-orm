...
<head>
    ...
    <title>TodoORM – Create Account</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-text {
            ...
            font-size: 22px; color: var(--text-dark); letter-spacing: -.3px;
        }
        ...
        .form-group label {
            ...
            color: var(--text-dark); margin-bottom: 7px; letter-spacing: .2px;
        }
        .input-wrap { position: relative; }
        .input-wrap .icon {
            position: absolute; left: 14px; top: 50%; transform: translateY(-50%);
            color: var(--pink-mid); pointer-events: none; display: flex; transition: color .2s;
        }
        .input-wrap input {
            width: 100%;
        ...
        .toggle-pw {
            ...
            color: var(--pink-mid); display: flex; transition: color .2s;
        }
        ...
        /* password match hint */
        .match-hint {
            font-size: 12px; margin-top: 5px; height: 16px;
            transition: color .2s;
        }

        .error-msg {
            font-size: 12px; color: #e53935;
            margin-top: 5px; display: flex; gap: 4px; align-items: center;
        }
        ...
        .login-prompt a:hover { border-color: var(--rose); }
...
<div class="card">
    ...
    <p class="sub">Start organizing your tasks beautifully.</p>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
            ...
            <div class="input-wrap">
                <span class="icon">
                    <svg width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                </span>
                <input id="password_confirmation" type="password" name="password_confirmation"
                    ...
                    oninput="checkMatch()"
                    required>
                <button type="button" class="toggle-pw" onclick="togglePw('password_confirmation',this)" aria-label="Show/hide password">
                    <svg width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                </button>
            </div>
...
function checkStrength(val) {
    ...
    const levels = [
        ...
        { w:'25%',  bg:'#e53935',     text:'Weak' },
        { w:'50%',  bg:'#fb8c00',     text:'Fair' },
        { w:'75%',  bg:'#43a047',     text:'Good' },
        { w:'100%', bg:'#2e7d32',     text:'Strong 💪' },
    ];
